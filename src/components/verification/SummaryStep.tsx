...
export function SummaryStep({
  ...
  if (!documentData) {
    return (
      <div className="text-center py-8">
        <p className="text-red-600 dark:text-red-400">Missing document data</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-strong rounded-lg p-6 border border-black/10 dark:border-white/10">
        <h3 className="text-sm font-semibold text-black/60 dark:text-white/60 uppercase mb-4">
